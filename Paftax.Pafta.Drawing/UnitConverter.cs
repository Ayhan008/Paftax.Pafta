...
public static class UnitConverter
{
    ...
    public static Point MmToInch(Point pt) => new(MmToInch(pt.X), MmToInch(pt.Y));
    public static Point InchToMm(Point pt) => new(InchToMm(pt.X), InchToMm(pt.Y));
    #endregion
    ...
    public static Point InchToFeet(Point pt) => new(InchToFeet(pt.X), InchToFeet(pt.Y));
    public static Point FeetToInch(Point pt) => new(FeetToInch(pt.X), FeetToInch(pt.Y));
    #endregion
    ...
    public static Point MmToFeet(Point pt) => new(MmToFeet(pt.X), MmToFeet(pt.Y));
    public static Point FeetToMm(Point pt) => new(FeetToMm(pt.X), FeetToMm(pt.Y));
    #endregion
    ...
    public static Point InchToPoint(Point pt) => new(InchToPoint(pt.X), InchToPoint(pt.Y));
    public static Point PointToInch(Point pt) => new(PointToInch(pt.X), PointToInch(pt.Y));
    #endregion
    ...
    public static Point MmToPoint(Point pt) => new(MmToPoint(pt.X), MmToPoint(pt.Y));
    public static Point PointToMm(Point pt) => new(PointToMm(pt.X), PointToMm(pt.Y));
    #endregion
    ...
    public static Point FeetToPoint(Point pt) => new(FeetToPoint(pt.X), FeetToPoint(pt.Y));
    public static Point PointToFeet(Point pt) => new(PointToFeet(pt.X), PointToFeet(pt.Y));
    #endregion
    ...
    public static Point PointToCm(Point pt) => new(PointToCm(pt.X), PointToCm(pt.Y));
    public static Point CmToPoint(Point pt) => new(CmToPoint(pt.X), CmToPoint(pt.Y));
    ...
    public static Point PointToM(Point pt) => new(PointToM(pt.X), PointToM(pt.Y));
    public static Point MToPoint(Point pt) => new(MToPoint(pt.X), MToPoint(pt.Y));
